      ...
      {loading ? (
        ...
        <>
          <div className="stats-grid">
            <StatCard label="Active Projects" value={stats.projects} icon="◈" color="var(--accent)" to="/admin/projects" />
            <StatCard label="Quotations" value={stats.quotations} icon="◇" color="#6366f1" to="/admin/quotations" />
            <StatCard label="Contracts" value={stats.contracts} icon="◻" color="#0ea5e9" to="/admin/contracts" />
            <StatCard label="Invoices" value={stats.invoices} icon="▤" color="#10b981" to="/admin/invoices" />
                ...
                <table className="dash-table">
                  ...
                  <tbody>
                    {recentConsultations.map((c) => (
                      <tr key={c.id}>
                        <td>{c.clientName || c.name}</td>
                        <td>{c.preferredDate ? new Date(c.preferredDate).toLocaleDateString() : '—'}</td>
