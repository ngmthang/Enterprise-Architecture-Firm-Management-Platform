            ...
            <div className="form-section">
                ...
                <div className="form-row">
                    <div className="form-field">
                        <label>Title *</label>
                        <input name="title" value={form.title} onChange={handleChange} placeholder="Office supplies" required />
                    </div>
                    <div className="form-field">
...
export default function ExpensesPage() {
    ...
    const filtered = expenses.filter(e => {
        const matchSearch = !search ||
            ...
            e.expenseReference?.toLowerCase().includes(search.toLowerCase());
            ...
            <div className="page-header">
                <div>
                    ...
                    <p className="page-subtitle">
                        ...
                        {pendingCount > 0 && <span className="pending-badge">{pendingCount} pending approval</span>}
                    </p>
                </div>
